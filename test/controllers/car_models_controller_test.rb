...
class CarModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_model" do
    assert_difference("CarModel.count") do
      post car_models_url, params: { car_model: { CarMake_id: @car_model.CarMake_id, model: @car_model.model } }
    end
  ...
  test "should update car_model" do
    patch car_model_url(@car_model), params: { car_model: { CarMake_id: @car_model.CarMake_id, model: @car_model.model } }
