...
class BodyTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create body_type" do
    assert_difference("BodyType.count") do
      post body_types_url, params: { body_type: { body_type: @body_type.body_type, car_model_id: @body_type.car_model_id } }
    end
  ...
  test "should update body_type" do
    patch body_type_url(@body_type), params: { body_type: { body_type: @body_type.body_type, car_model_id: @body_type.car_model_id } }
